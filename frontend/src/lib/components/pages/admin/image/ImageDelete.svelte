<script lang="ts">
  ...
  import { deleteBaseImage } from '$lib/service/baseImageService';
  ...
  async function handleDelete() {
    ...
    await deleteBaseImage(id).catch(e => {
...
<DefaultDialog bind:this={dialog}>
  <svelte:fragment slot="title">Delete base image</svelte:fragment>
  <svelte:fragment slot="content">
    <div class="grid w-[30rem] min-w-10 max-w-[50rem] gap-6 px-4 py-2">
      <p>Are you sure you want to delete this image?</p>
      <p>This action is not reversible, any apps created from this image will remain</p>
    </div>
  </svelte:fragment>

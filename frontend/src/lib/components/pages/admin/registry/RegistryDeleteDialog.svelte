<script lang="ts">
  ...
  import { deleteRegistryImage } from '$lib/service/registryService';
  ...
  async function handleDelete() {
    ...
    await deleteRegistryImage(id).catch(e => {
...
<DefaultDialog bind:this={dialog}>
  <svelte:fragment slot="title">Delete registry image</svelte:fragment>
